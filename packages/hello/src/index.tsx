...
// PluginContext is injected by Origin at mount time. These values are stable for
// the lifetime of the card — they do not change reactively.
export default function HelloPlugin({ context }: { context: PluginContext }) {
