import { c as P, l as _, e as B } from "./monaco-editor-DYCCzzuR.js";
import {
  f as Y,
  g as J,
  C as Q,
  ...
  S as $,
  e as K,
} from "./lspLanguageFeatures-CPe9Q1Rb.js";
import {
  a as Ae,
  D as Oe,
  h as Ie,
    ...
    return (
      ...
      this._client ||
        ((this._worker = P({
          ...
          createWorker: () =>
            new Worker(
              new URL("/assets/json.worker-BoL8UZqY.js", import.meta.url),
              { type: "module" },
            ),
...
`;
  ...
  function D() {
    ...
    if (E(s)) {
      do (n++, (u += String.fromCharCode(s)), (s = e.charCodeAt(n)));
      while (E(s));
      return (l = 15);
    }
    if (I(s))
...
`)),
    ...
    switch (s) {
      ...
      case 47:
        ...
        if (e.charCodeAt(n + 1) === 42) {
          ...
          for (; n < a; ) {
            ...
            (n++,
              I(f) &&
                (f === 13 && e.charCodeAt(n) === 10 && n++, o++, (w = n)));
          }
      ...
      case 45:
        if (
          ((u += String.fromCharCode(s)), n++, n === t || !T(e.charCodeAt(n)))
        )
          return (l = 16);
      case 48:
      case 49:
...
` + " ".repeat(i),
  ...
  new Array(A).fill(0).map((e, i) => "\r" + " ".repeat(i)),
  new Array(A).fill(0).map(
    (e, i) =>
      `\r
` + " ".repeat(i),
...
const M = "delimiter.bracket.json",
  S = "delimiter.array.json",
  te = "delimiter.colon.json",
  se = "delimiter.comma.json",
  le = "keyword.json",
  ue = "keyword.json",
  oe = "string.value.json",
  ce = "number.json",
  fe = "string.key.json",
  pe = "comment.block.json",
  ge = "comment.line.json";
class b {
  constructor(i, t) {
    ...
    return i === this
      ...
      : !i || !(i instanceof L)
        ...
        : this.scanError === i.scanError &&
          ...
          b.equals(this.parents, i.parents);
  }
  getStateData() {
    return this._state;
  }
...
function me(e, i, t, n = 0) {
  ...
  const l = ne(i);
  let o = t.lastWasColon,
    g = t.parents;
  const w = { tokens: [], endState: t.clone() };
  for (;;) {
    let v = n + l.getPosition(),
      c = "";
    const O = l.scan();
    if (O === 17) break;
    if (v === n + l.getPosition())
      throw new Error(
        "Scanner did not advance, next 3 characters are: " +
          i.substr(l.getPosition(), 3),
      );
    switch ((p && (v -= u), (p = u > 0), O)) {
      case 1:
        ((g = b.push(g, 0)), (c = M), (o = !1));
        break;
      case 2:
        ((g = b.pop(g)), (c = M), (o = !1));
        break;
      case 3:
        ((g = b.push(g, 1)), (c = S), (o = !1));
        break;
      case 4:
        ((g = b.pop(g)), (c = S), (o = !1));
        break;
    ...
    ((w.endState = new L(t.getStateData(), l.getTokenError(), o, g)),
      w.tokens.push({ startIndex: v, scopes: c }));
  }
  return w;
}
let k;
  ...
  function u() {
    ...
    (q(t),
      o.documentFormattingEdits &&
        t.push(_.registerDocumentFormattingEditProvider(l, new Y(k))),
      o.documentRangeFormattingEdits &&
        t.push(_.registerDocumentRangeFormattingEditProvider(l, new J(k))),
      o.completionItems &&
        t.push(_.registerCompletionItemProvider(l, new Q(k, [" ", ":", '"']))),
      o.hovers && t.push(_.registerHoverProvider(l, new y(k))),
      o.documentSymbols &&
        t.push(_.registerDocumentSymbolProvider(l, new G(k))),
      o.tokens && t.push(_.setTokensProvider(l, ie(!0))),
      o.colors && t.push(_.registerColorProvider(l, new Z(k))),
      o.foldingRanges && t.push(_.registerFoldingRangeProvider(l, new X(k))),
      o.diagnostics && t.push(new re(l, k, e)),
      o.selectionRanges &&
        t.push(_.registerSelectionRangeProvider(l, new $(k))));
  }
