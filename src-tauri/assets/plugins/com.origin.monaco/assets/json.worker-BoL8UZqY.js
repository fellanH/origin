...
` +
  ...
  function jo(t, e = "Unreachable") {
    throw new Error(e);
  }
  function Wo(t, e = "unexpected state") {
  ...
  (function (t) {
    ...
    t.flatMap = p;
    function* y(...L) {
      for (const S of L) zo(S) ? yield* S : yield S;
    }
    t.concat = y;
    function x(L, S, P) {
      let D = P;
  ...
  const Qo = globalThis.performance.now.bind(globalThis.performance);
  class hn {
    static create(e) {
      return new hn(e);
    }
    constructor(e) {
      ((this._now = e === !1 ? Date.now : Qo),
  ...
  (function (t) {
    ...
    function u(...w) {
      return (k, C = null, I) => {
        const F = Go(...w.map((V) => V((q) => k.call(C, q))));
        return f(F, I);
      };
    }
    t.any = u;
...
`),
      ...
      ((this._size = 0),
        ...
        (this._leakageMon = this._options?.leakWarningThreshold
          ? new Jn(
              ...
              this._options?.leakWarningThreshold ?? Zo,
            )
          : void 0),
  ...
  function $(t, e, ...n) {
    return ui(typeof t == "number" ? il(t, e) : e, n);
  }
  function il(t, e) {
    const n = nl()?.[t];
    if (typeof n != "string") {
    ...
    if (t)
      try {
        ...
        ((mn = e.userLocale),
          ...
          (sl = e.languagePack?.translationsConfigFile));
      } catch {}
  } else
    typeof navigator == "object" && !al
  ...
  const $t = Zn,
    ol = Yn,
    Ce = $e,
    ll = typeof tt.postMessage == "function" && !tt.importScripts;
  (() => {
    if (ll) {
      const t = [];
  ...
  const ul = !!(Ce && Ce.indexOf("Chrome") >= 0);
  (Ce && Ce.indexOf("Firefox") >= 0,
    !ul && Ce && Ce.indexOf("Safari") >= 0,
    Ce && Ce.indexOf("Edg/") >= 0,
  ...
  class fl {
    constructor(e, n) {
      ((this.lastCache = void 0),
        ...
        typeof e == "function"
          ? ((this._fn = e), (this._computeKey = cl))
  ...
  ((Oe.ambiguousCharacterData = new tr(() =>
    ...
    (Oe.cache = new fl({ getCacheKey: JSON.stringify }, (e) => {
      function n(h) {
        const f = new Map();
      ...
      const s = new Pe({
        onWillAddFirstListener: () => {
          ((i = String(++this._lastSentReq)),
            ...
            this._send(new Al(this._workerId, i, e, n, r)));
        },
        onDidRemoveLastListener: () => {
          (this._pendingEmitters.delete(i),
            this._send(new Rl(this._workerId, i)),
            (i = null));
        },
      });
      return s.event;
    ...
    _handleSubscribeEventMessage(e) {
      const n = e.req,
        r = this._handler.handleEvent(
          ...
          this._send(new kl(this._workerId, n, i));
        });
  ...
  class Ml {
    ...
    _handleMessage(e, n, r) {
      if (e === rr && n === _l) return this.initialize(r[0]);
  ...
  class Ge {
    ...
    static _getElements(e) {
      ...
      if (Ge._isStringArray(n)) {
        ...
        for (let i = 0, s = n.length; i < s; i++) r[i] = Pl(n[i], 0);
        return [n, r, !0];
      }
  ...
  (function () {
    ...
    for (const i of e) {
      ...
      if (
        (r[a] || ((r[a] = !0), (Ul[o] = a), (ql[o.toLowerCase()] = a)), !n[u])
      ) {
        if (((n[u] = !0), !l))
          throw new Error(
  ...
  if (typeof cr < "u" && typeof cr.process < "u") {
    ...
    typeof process < "u" && typeof process?.versions?.node == "string"
      ? (pt = {
          ...
          cwd() {
            return Li.VSCODE_CWD || process.cwd();
          },
        })
      : (pt = {
          get platform() {
            return $t ? "win32" : ol ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function Zl(t, e) {
    if (t === null || typeof t != "object") throw new Ni(e, "Object", t);
  }
  function te(t, e) {
    if (typeof t != "string") throw new Ni(e, "string", t);
  }
  const Je = Hl === "win32";
  function U(t) {
    return t === ae || t === de;
      ...
      toNamespacedPath(t) {
        ...
        if (e.charCodeAt(0) === de) {
          if (e.charCodeAt(1) === de) {
            ...
            if (n !== Ql && n !== rt) return `\\\\?\\UNC\\${e.slice(2)}`;
          }
        } else if (
          Ue(e.charCodeAt(0)) &&
          e.charCodeAt(1) === Be &&
      ...
      if (e) {
        if (e instanceof jn) return e;
        {
          ...
          return (
            ...
            (n._fsPath = e._sep === Si ? (e.fsPath ?? null) : null),
            n
          );
        }
      } else return e;
  ...
  class bt extends hr {
    ...
    toJSON() {
      const e = { $mid: 1 };
      return (
        this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Si)),
  ...
  function ou(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const r = t.charCodeAt(n);
      r === 35 || r === 63
        ? (e === void 0 && (e = t.substr(0, n)), (e += Ai[r]))
        : e !== void 0 && (e += t[n]);
    }
    return e !== void 0 ? e : t;
  }
  ...
  function Ri(t) {
    try {
      ...
      return t.length > 3 ? t.substr(0, 3) + Ri(t.substr(3)) : t;
    }
  }
  const Ei = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
  function xn(t) {
    return t.match(Ei) ? t.replace(Ei, (e) => Ri(e)) : t;
  }
  class be extends B {
    constructor(e, n, r, i) {
      (super(e, n, r, i),
  ...
  function vu(t, e, n, r, i) {
    return wu(t, e, n, r, i) && xu(t, e, n, r, i);
  }
  class Lu {
    constructor(e, n) {
    ...
    next(e) {
      ...
      do {
        ...
        if (i === this._prevMatchStartIndex && s === this._prevMatchLength) {
          if (s === 0) {
            vl(e, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || vu(this._wordSeparators, e, n, i, s))
        )
          return r;
      } while (r);
      return null;
  ...
  function _u(t = "") {
    let e = "(-?\\d*\\.\\d\\w*)|([^";
    for (const n of Nu) t.indexOf(n) >= 0 || (e += "\\" + n);
  ...
  const Us = new Xo();
  Us.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  function xr(t, e, n, r, i) {
    if (((e = Bs(e)), i || (i = cn.first(Us)), n.length > i.maxLen)) {
      let l = t - i.maxLen / 2;
      return (
        l < 0 ? (l = 0) : (r += l),
  ...
  class Au {
    static computeUnicodeHighlights(e, n, r) {
      ...
      o === "allNonBasicAscii"
        ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (u = new RegExp(`${ku(Array.from(o))}`, "g"));
      const l = new Lu(null, u),
        h = [];
      let f = !1,
        m,
        g = 0,
  ...
  function ku(t, e) {
    return `[${hl(t.map((r) => String.fromCodePoint(r)).join(""))}]`;
  }
  class qs {
    constructor(e) {
      ((this.options = e),
    ...
    getCandidateCodePoints() {
      ...
      if (this.options.invisibleCharacters)
        for (const n of Ut.codePoints) js(String.fromCodePoint(n)) || e.add(n);
...
` &&
  ...
  class Ou {
    ...
    getTransformer() {
      return (
        this._transformer || (this._transformer = new Du(this.getValue())),
        this._transformer
      );
    }
    getLineAt(e) {
  ...
  class $u extends Ou {
    constructor(e, n) {
      (Wo(n >= 1), super(), (this._getLineContent = e), (this._lineCount = n));
    }
    getValueOfRange(e) {
...
`,
  ...
  class Le {
    ...
    toRangeMapping2(e, n) {
      if (
        Hs(this.original.endLineNumberExclusive, e) &&
        Hs(this.modified.endLineNumberExclusive, n)
      )
        return new Ne(
          new B(
            this.original.startLineNumber,
...
`);
  ...
  class Qs {
    compute(e, n, r = Gt.instance) {
      ...
      u.set(0, a(0, 0));
      const l = new Xu();
      l.set(0, u.get(0) === 0 ? null : new Zs(null, 0, 0, u.get(0)));
      let h = 0;
      e: for (;;) {
        ...
        for (h = p; h <= y; h += 2) {
          ...
          if (
            (l.set(h, N !== b ? new Zs(E, b, _, N - b) : E),
  ...
  class Sn {
    ...
    findSubWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Nt(this.elements[e])) return;
      let n = e;
      for (; n > 0 && Nt(this.elements[n - 1]) && !Ys(this.elements[n]); ) n--;
      let r = e;
      for (
        ;
    ...
    extendToFullLines(e) {
      const n = yt(this.firstElementOffsetByLineIdx, (i) => i <= e.start) ?? 0,
        r =
          Fu(this.firstElementOffsetByLineIdx, (i) => e.endExclusive <= i) ??
  ...
  const Qu = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
  function Ks(t) {
    return Qu[t];
  }
  function ea(t) {
  ...
  function Zu(t, e, n, r, i, s) {
    let { moves: a, excludedChanges: o } = Ku(t, e, n, s);
    if (!s.isValid()) return [];
...
`).length >= 15 && Yu(f, (g) => g.length >= 2) >= 2
  ...
  function ec(t, e, n, r, i, s) {
    ...
    u.sort(Iu(jt((m) => m.modifiedLineRange.length, Wt)));
    const l = new Ie(),
      h = new Ie();
    for (const m of u) {
      const g =
  ...
  function na(t, e, n) {
    let r = n;
    return ((r = ra(t, e, r)), (r = ra(t, e, r)), (r = rc(t, e, r)), r);
  }
  function ra(t, e, n) {
  ...
  function rc(t, e, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      ...
      s.seq1Range.isEmpty
        ? (n[r] = ia(s, t, e, o, u))
        : s.seq2Range.isEmpty && (n[r] = ia(s.swap(), e, t, u, o).swap());
    }
    return n;
  }
  ...
  class aa {
    ...
    getBoundaryScore(e) {
      const n = e === 0 ? 0 : oa(this.lines[e - 1]),
        r = e === this.lines.length ? 0 : oa(this.lines[e]);
      return 1e3 - (n + r);
    }
    getText(e) {
...
`);
  ...
  class lc {
    constructor() {
      ((this.dynamicProgrammingDiffing = new Gu()),
        (this.myersDiffingAlgorithm = new Qs()));
    }
    computeDiff(e, n, r) {
      if (e.length <= 1 && Eu(e, n, (L, S) => L === S))
        return new vn([], [], !1);
      if (
    ...
    computeMoves(e, n, r, i, s, a, o, u) {
      return Zu(e, n, r, i, s, a).map((f) => {
        const m = this.refineDiff(
          ...
          g = zs(m.mappings, new Nn(n), new Nn(r), !0);
        return new Ru(f, g);
      });
    }
    refineDiff(e, n, r, i, s, a) {
      const u = uc(r).toRangeMapping2(e, n),
      ...
      return (
        (m = na(l, h, m)),
        (m = sa(l, h, m, (d, p) => d.findWordContaining(p))),
        a.extendToSubwords &&
          (m = sa(l, h, m, (d, p) => d.findSubWordContaining(p), !0)),
        (m = ic(l, h, m)),
        (m = oc(l, h, m)),
        {
          mappings: m.map(
  ...
  const la = { getLegacy: () => new qu(), getDefault: () => new lc() };
  function Qe(t, e) {
  ...
  function bc(t, e) {
    ...
    if (!e.markSectionHeaderRegex || e.markSectionHeaderRegex.trim() === "")
      return n;
    const i = yu(e.markSectionHeaderRegex),
      s = new RegExp(e.markSectionHeaderRegex, `gdm${i ? "s" : ""}`);
    if (ml(s)) return n;
    for (let a = 1; a <= r; a += ha - dc) {
      const o = Math.min(a + ha - 1, r),
        u = [];
...
`) + 1,
  ...
  class Sc extends Nc {
    ...
    getWordAtPosition(e, n) {
      const r = xr(e.column, Bs(n), this._lines[e.lineNumber - 1], 0);
      return r
  ...
  const ut = class ut {
    constructor(e = null) {
      ((this._foreignModule = e),
        ...
        (this._workerTextModelSyncServer = new _c()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeUnicodeHighlights(e, n, r) {
      ...
      return i
        ? Au.computeUnicodeHighlights(i, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    static computeDiff(e, n, r, i) {
      const s = i === "advanced" ? la.getDefault() : la.getLegacy(),
        a = e.getLinesContent(),
        o = n.getLinesContent(),
  ...
  let Rr = ut;
  typeof importScripts == "function" && (globalThis.monaco = mu());
  const an = class an {
    static getChannel(e) {
...
`,
  ...
  function Ec(t, e, n) {
    let r, i, s, a, o;
    if (e) {
      for (a = e.offset, o = a + e.length, s = a; s > 0 && !ba(t, s - 1); ) s--;
      let N = o;
      for (; N < t.length && !ba(t, N); ) N++;
      ((i = t.substring(s, N)), (r = Mc(i, n)));
...
` &&
  ...
  class en {
    ...
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 &&
          (this._lineOffsets = xo(this._content, !0)),
        this._lineOffsets
      );
    }
    positionAt(e) {
  ...
  var jc = /{([^}]+)}/g;
  function Wc(t, e) {
    return Object.keys(e).length === 0 ? t : t.replace(jc, (n, r) => e[r] ?? n);
  }
  const Hc = {
    "color-hex": {
      errorMessage: M(
  ...
  class Xr {
    ...
    include(e) {
      return (
        (this.focusOffset === -1 || So(e, this.focusOffset)) &&
        e !== this.exclude
      );
    }
    newSub() {
  ...
  class Ao {
    ...
    getNodeFromOffset(e, n = !1) {
      if (this.root) return Vc(this.root, e, n);
    }
    visit(e) {
      if (this.root) {
        const n = (r) => {
    ...
    validate(e, n, r = ye.Warning, i) {
      if (this.root && n) {
        const s = new ce();
        return (
          oe(this.root, n, s, tn.instance, new _o(i ?? ko(n))),
          s.problems.map((a) => {
            const o = W.create(
  ...
  function Kc(t, e) {
    ...
    function d(E, L) {
      const S = new Xc(E, s.getTokenOffset(), g);
      let P = y(S);
      if (!P)
        if (s.getToken() === 16) {
          l(
    ...
    function p(E) {
      ...
      const L = new Qc(E, s.getTokenOffset()),
    ...
    function x(E) {
      ...
      const L = new Jc(E, s.getTokenOffset());
    ...
    function v(E) {
      switch (s.getToken()) {
        case 7:
          return f(new zc(E, s.getTokenOffset()), !0);
        case 8:
          return f(new Lo(E, !0, s.getTokenOffset()), !0);
        case 9:
          return f(new Lo(E, !1, s.getTokenOffset()), !0);
        default:
          return;
      }
    }
...
$3`,
  ...
  class r1 {
    ...
    doValidation(e, n, r, i) {
      ...
      const s = [],
        ...
        u = (l) => {
          ...
          if (l) {
            ...
            (Ro(l.schema) && (f = void 0), Eo(l.schema) && (h = void 0));
          }
      ...
      if (i) {
        const l = i.id || "schemaservice://untitled/" + i1++;
  ...
  function ne(t) {
    return t < Mo
      ...
      : t <= s1
        ? t - Mo
        : (t < In && (t += In - a1), t >= In && t <= o1 ? t - In + 10 : 0);
  }
  function l1(t) {
    if (t[0] === "#")
      switch (t.length) {
    ...
    constructor(e, n, r) {
      ...
      try {
        for (let i of e) {
          ...
          (s || (i = i.substring(1)),
            i.length > 0 &&
              (i[0] === m1 && (i = i.substring(1)),
              this.globWrappers.push({
                regexp: f1("**/" + i, { extended: !0, globstar: !0 }),
                include: s,
              })));
        }
        n &&
          ((n = Io(n)), n.endsWith("/") || (n = n + "/"), (this.folderUri = n));
      } catch {
  ...
  class p1 {
    ...
    resolveSchemaContent(e, n) {
      ...
      if (s === "http://json-schema.org/draft-03/schema")
        return this.promise.resolve(
          new Co({}, [M("Draft-03 schemas are not supported.")], [], s),
        );
      let a = new Set();
        ...
        d = (p) => {
          ...
          return (
            this.traverseNodes(p, (x) => {
              const v = x.$id || x.id,
                b = Na(v) && v.charAt(0) === "#" ? v.substring(1) : x.$anchor;
              (b &&
                (y.has(b)
    ...
    getMatchingSchemas(e, n, r) {
      if (r) {
        const i = r.id || "schemaservice://untitled/matchingSchemas/" + b1++;
...
`,
    ...
    addChildProperty(e) {
      if (((e.parent = this), this.childrenProperties.length > 0)) {
        ...
        (e.noKeyName
          ...
          : (n = v1(this.childrenProperties, e, x1)),
          n < 0 && (n = n * -1 - 1),
  ...
  function _1(t, e) {
    ...
    const n = Ee.create("test://test.json", "json", 0, t.getText()),
      r = [];
    for (Fo(r, e, e.beginningLineNumber); r.length > 0; ) {
      const i = r.shift(),
      ...
      for (let o = 0; o < s.length; o++) {
        ...
        (Ee.update(n, [g], 1), Fo(r, u, a), (a = a + m));
      }
    }
    return n;
  }
  function Fo(t, e, n) {
    if (e.childrenProperties.length !== 0)
      if (e.type === se.Object) {
        ...
        ((n = n + i), t.push(new Do(n, e.childrenProperties)));
      } else e.type === se.Array && Vo(t, e, n);
  }
  function Vo(t, e, n) {
    for (const r of e.childrenProperties) {
      ...
      r.type === se.Array &&
        Vo(t, r, n + r.beginningLineNumber - e.beginningLineNumber);
    }
  }
  class Do {
    constructor(e, n) {
  ...
  function M1(t) {
    const e = t.promiseConstructor || Promise,
      n = new p1(t.schemaRequestService, t.workspaceContext, e);
    n.setSchemaContributions(Kr);
    const r = new e1(n, t.contributions, e, t.clientCapabilities),
      i = new t1(n, t.contributions, e),
      s = new u1(n),
      a = new r1(n, e);
    return {
      configure: (o) => {
      ...
      parseJSONDocument: (o) => Kc(o, { collectComments: !0 }),
      newJSONDocument: (o, u) => Yc(o, u),
    ...
    constructor(e, n) {
      ((this._ctx = e),
        ...
        (this._languageService = M1({
          ...
          schemaRequestService: n.enableSchemaRequest ? Oo : void 0,
  ...
  const P1 = 47,
    ni = 46;
  function C1(t) {
    return t.charCodeAt(0) === P1;
  }
  function I1(t, e) {
    if (C1(e)) {
      const n = Pt.parse(t),
        r = e.split("/");
      return n.with({ path: $o(r) }).toString();
    }
    return F1(t, e);
  }
  function $o(t) {
