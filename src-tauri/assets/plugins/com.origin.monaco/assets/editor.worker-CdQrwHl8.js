...
` +
  ...
  (function (t) {
    ...
    t.flatMap = d;
    function* x(...w) {
      for (const y of w) js(y) ? yield* y : yield y;
    }
    t.concat = x;
    function N(w, y, A) {
      let D = A;
  ...
  (function (t) {
    ...
    function u(..._) {
      return (S, k = null, R) => {
        const F = Os(..._.map((U) => U((W) => S.call(k, W))));
        return f(F, R);
      };
    }
    t.any = u;
...
`),
      ...
      ((this._size = 0),
        ...
        (this._leakageMon = this._options?.leakWarningThreshold
          ? new Gt(
              ...
              this._options?.leakWarningThreshold ?? Ys,
            )
          : void 0),
  ...
  function P(t, e, ...n) {
    return Fn(typeof t == "number" ? si(t, e) : e, n);
  }
  function si(t, e) {
    const n = ni()?.[t];
    if (typeof n != "string") {
    ...
    if (t)
      try {
        ...
        ((_t = e.userLocale),
          ...
          (ii = e.languagePack?.translationsConfigFile));
      } catch {}
  } else
    typeof navigator == "object" && !ai
  ...
  const nt = Xt,
    li = Qt,
    me = be,
    oi = typeof Ce.postMessage == "function" && !Ce.importScripts;
  (() => {
    if (oi) {
      const t = [];
  ...
  const ui = !!(me && me.indexOf("Chrome") >= 0);
  (me && me.indexOf("Firefox") >= 0,
    !ui && me && me.indexOf("Safari") >= 0,
    me && me.indexOf("Edg/") >= 0,
  ...
  class hi {
    constructor(e, n) {
      ((this.lastCache = void 0),
        ...
        typeof e == "function"
          ? ((this._fn = e), (this._computeKey = ci))
  ...
  ((ge.ambiguousCharacterData = new Zt(() =>
    ...
    (ge.cache = new hi({ getCacheKey: JSON.stringify }, (e) => {
      function n(h) {
        const f = new Map();
      ...
      const i = new fe({
        ...
        onDidRemoveLastListener: () => {
          (this._pendingEmitters.delete(s),
            this._send(new Ci(this._workerId, s)),
            (s = null));
        },
      });
      return i.event;
    ...
    _handleSubscribeEventMessage(e) {
      const n = e.req,
        r = this._handler.handleEvent(
          ...
          this._send(new Ri(this._workerId, n, s));
        });
  ...
  class ki {
    ...
    _handleMessage(e, n, r) {
      if (e === en && n === Ni) return this.initialize(r[0]);
  ...
  class ve {
    ...
    static _getElements(e) {
      ...
      if (ve._isStringArray(n)) {
        ...
        for (let s = 0, i = n.length; s < i; s++) r[s] = Pi(n[s], 0);
        return [n, r, !0];
      }
  ...
  (function () {
    ...
    for (const s of e) {
      ...
      if (
        (r[l] || ((r[l] = !0), ($i[o] = l), (Hi[o.toLowerCase()] = l)), !n[u])
      ) {
        if (((n[u] = !0), !c))
          throw new Error(
  ...
  if (typeof on < "u" && typeof on.process < "u") {
    ...
    typeof process < "u" && typeof process?.versions?.node == "string"
      ? (Ue = {
          ...
          cwd() {
            return jn.VSCODE_CWD || process.cwd();
          },
        })
      : (Ue = {
          get platform() {
            return nt ? "win32" : li ? "darwin" : "linux";
          },
          get arch() {},
          get env() {
            return {};
  ...
  function Yi(t, e) {
    if (t === null || typeof t != "object") throw new On(e, "Object", t);
  }
  function X(t, e) {
    if (typeof t != "string") throw new On(e, "string", t);
  }
  const Ne = Gi === "win32";
  function I(t) {
    return t === Q || t === te;
      ...
      toNamespacedPath(t) {
        ...
        if (e.charCodeAt(0) === te) {
          if (e.charCodeAt(1) === te) {
            ...
            if (n !== Ji && n !== ke) return `\\\\?\\UNC\\${e.slice(2)}`;
          }
        } else if (
          we(e.charCodeAt(0)) &&
          e.charCodeAt(1) === pe &&
      ...
      if (e) {
        if (e instanceof Me) return e;
        {
          ...
          return (
            ...
            (n._fsPath = e._sep === Qn ? (e.fsPath ?? null) : null),
            n
          );
        }
      } else return e;
  ...
  class $e extends Me {
    ...
    toJSON() {
      const e = { $mid: 1 };
      return (
        this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Qn)),
  ...
  function la(t) {
    ...
    for (let n = 0; n < t.length; n++) {
      const r = t.charCodeAt(n);
      r === 35 || r === 63
        ? (e === void 0 && (e = t.substr(0, n)), (e += Jn[r]))
        : e !== void 0 && (e += t[n]);
    }
    return e !== void 0 ? e : t;
  }
  ...
  function Zn(t) {
    try {
      ...
      return t.length > 3 ? t.substr(0, 3) + Zn(t.substr(3)) : t;
    }
  }
  const Kn = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
  function Ct(t) {
    return t.match(Kn) ? t.replace(Kn, (e) => Zn(e)) : t;
  }
  class se extends C {
    constructor(e, n, r, s) {
      (super(e, n, r, s),
  ...
  function _a(t, e, n, r, s) {
    return xa(t, e, n, r, s) && ya(t, e, n, r, s);
  }
  class La {
    constructor(e, n) {
    ...
    next(e) {
      ...
      do {
        ...
        if (s === this._prevMatchStartIndex && i === this._prevMatchLength) {
          if (i === 0) {
            _i(e, n, this._searchRegex.lastIndex) > 65535
        ...
        if (
          ...
          !this._wordSeparators || _a(this._wordSeparators, e, n, s, i))
        )
          return r;
      } while (r);
      return null;
  ...
  function Na(t = "") {
    let e = "(-?\\d*\\.\\d\\w*)|([^";
    for (const n of va) t.indexOf(n) >= 0 || (e += "\\" + n);
  ...
  const fs = new Qs();
  fs.unshift({ maxLen: 1e3, windowSize: 15, timeBudget: 150 });
  function pn(t, e, n, r, s) {
    if (((e = hs(e)), s || (s = wt.first(fs)), n.length > s.maxLen)) {
      let c = t - s.maxLen / 2;
      return (
        c < 0 ? (c = 0) : (r += c),
  ...
  class Aa {
    static computeUnicodeHighlights(e, n, r) {
      ...
      o === "allNonBasicAscii"
        ? (u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g"))
        : (u = new RegExp(`${Ra(Array.from(o))}`, "g"));
      const c = new La(null, u),
        h = [];
      let f = !1,
        m,
        p = 0,
  ...
  function Ra(t, e) {
    return `[${fi(t.map((r) => String.fromCodePoint(r)).join(""))}]`;
  }
  class ms {
    constructor(e) {
      ((this.options = e),
    ...
    getCandidateCodePoints() {
      ...
      if (this.options.invisibleCharacters)
        for (const n of st.codePoints) ds(String.fromCodePoint(n)) || e.add(n);
...
` &&
  ...
  class Ba {
    ...
    getTransformer() {
      return (
        this._transformer || (this._transformer = new Ia(this.getValue())),
        this._transformer
      );
    }
    getLineAt(e) {
...
`,
  ...
  class ae {
    ...
    toRangeMapping2(e, n) {
      if (
        bs(this.original.endLineNumberExclusive, e) &&
        bs(this.modified.endLineNumberExclusive, n)
      )
        return new le(
          new C(
            this.original.startLineNumber,
  ...
  class Ga {
    constructor(e, n, r) {
      ((this.shouldComputeCharChanges = r.shouldComputeCharChanges),
        ...
        (this.continueLineDiff = ys(r.maxComputationTime)),
        (this.continueCharDiff = ys(
...
`);
  ...
  class _s {
    compute(e, n, r = ct.instance) {
      ...
      u.set(0, l(0, 0));
      const c = new Qa();
      c.set(0, u.get(0) === 0 ? null : new Ls(null, 0, 0, u.get(0)));
      let h = 0;
      e: for (;;) {
        ...
        for (h = d; h <= x; h += 2) {
          ...
          if (
            (c.set(h, T !== L ? new Ls(q, L, E, T - L) : q),
  ...
  class Ft {
    ...
    getBoundaryScore(e) {
      const n = Ss(e > 0 ? this.elements[e - 1] : -1),
        r = Ss(e < this.elements.length ? this.elements[e] : -1);
      if (n === 7 && r === 8) return 0;
      if (n === 8) return 150;
      let s = 0;
      return (
    ...
    findSubWordContaining(e) {
      if (e < 0 || e >= this.elements.length || !Oe(this.elements[e])) return;
      let n = e;
      for (; n > 0 && Oe(this.elements[n - 1]) && !vs(this.elements[n]); ) n--;
      let r = e;
      for (
        ;
    ...
    extendToFullLines(e) {
      const n = He(this.firstElementOffsetByLineIdx, (s) => s <= e.start) ?? 0,
        r =
          Da(this.firstElementOffsetByLineIdx, (s) => e.endExclusive <= s) ??
  ...
  const Ja = { 0: 0, 1: 0, 2: 0, 3: 10, 4: 2, 5: 30, 6: 3, 7: 10, 8: 10 };
  function Ns(t) {
    return Ja[t];
  }
  function Ss(t) {
  ...
  function Ya(t, e, n, r, s, i) {
    let { moves: l, excludedChanges: o } = Ka(t, e, n, i);
    if (!i.isValid()) return [];
...
`).length >= 15 && Za(f, (p) => p.length >= 2) >= 2
  ...
  function e1(t, e, n, r, s, i) {
    ...
    u.sort(Ta(at((m) => m.modifiedLineRange.length, lt)));
    const c = new de(),
      h = new de();
    for (const m of u) {
      const p =
  ...
  function Rs(t, e, n) {
    let r = n;
    return ((r = Cs(t, e, r)), (r = Cs(t, e, r)), (r = r1(t, e, r)), r);
  }
  function Cs(t, e, n) {
  ...
  function r1(t, e, n) {
    ...
    for (let r = 0; r < n.length; r++) {
      ...
      i.seq1Range.isEmpty
        ? (n[r] = Es(i, t, e, o, u))
        : i.seq2Range.isEmpty && (n[r] = Es(i.swap(), e, t, u, o).swap());
    }
    return n;
  }
  ...
  class Ms {
    ...
    getBoundaryScore(e) {
      const n = e === 0 ? 0 : Ps(this.lines[e - 1]),
        r = e === this.lines.length ? 0 : Ps(this.lines[e]);
      return 1e3 - (n + r);
    }
    getText(e) {
...
`);
  ...
  class o1 {
    constructor() {
      ((this.dynamicProgrammingDiffing = new Oa()),
        (this.myersDiffingAlgorithm = new _s()));
    }
    computeDiff(e, n, r) {
      if (e.length <= 1 && Ea(e, n, (w, y) => w === y))
        return new Et([], [], !1);
      if (
    ...
    computeMoves(e, n, r, s, i, l, o, u) {
      return Ya(e, n, r, s, i, l).map((f) => {
        const m = this.refineDiff(
          ...
          p = ps(m.mappings, new Mt(n), new Mt(r), !0);
        return new Ca(f, p);
      });
    }
    refineDiff(e, n, r, s, i, l) {
      const u = u1(r).toRangeMapping2(e, n),
      ...
      return (
        (m = Rs(c, h, m)),
        (m = ks(c, h, m, (b, d) => b.findWordContaining(d))),
        l.extendToSubwords &&
          (m = ks(c, h, m, (b, d) => b.findSubWordContaining(d), !0)),
        (m = s1(c, h, m)),
        (m = l1(c, h, m)),
        {
          mappings: m.map(
  ...
  const Fs = { getLegacy: () => new Ha(), getDefault: () => new o1() };
  function Ae(t, e) {
  ...
  function p1(t, e) {
    ...
    if (!e.markSectionHeaderRegex || e.markSectionHeaderRegex.trim() === "")
      return n;
    const s = wa(e.markSectionHeaderRegex),
      i = new RegExp(e.markSectionHeaderRegex, `gdm${s ? "s" : ""}`);
    if (mi(i)) return n;
    for (let l = 1; l <= r; l += Is - d1) {
      const o = Math.min(l + Is - 1, r),
        u = [];
...
`) + 1,
  ...
  function w1(t) {
    ...
    return ((t = t.replace(m1, "")), { text: t, hasSeparatorLine: e });
  }
  class x1 {
    get isRejected() {
  ...
  class S1 extends v1 {
    ...
    getWordAtPosition(e, n) {
      const r = pn(e.column, hs(n), this._lines[e.lineNumber - 1], 0);
      return r
  ...
  const Fe = class Fe {
    constructor(e = null) {
      ((this._foreignModule = e),
        ...
        (this._workerTextModelSyncServer = new N1()));
    }
    dispose() {}
    async $ping() {
      return "pong";
    ...
    async $computeUnicodeHighlights(e, n, r) {
      ...
      return s
        ? Aa.computeUnicodeHighlights(s, n, r)
        : {
            ranges: [],
            hasMore: !1,
    ...
    static computeDiff(e, n, r, s) {
      const i = s === "advanced" ? Fs.getDefault() : Fs.getLegacy(),
        l = e.getLinesContent(),
        o = n.getLinesContent(),
  ...
  let Sn = Fe;
  typeof importScripts == "function" && (globalThis.monaco = ma());
  const dt = class dt {
    static getChannel(e) {
