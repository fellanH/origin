import { l as c } from "./monaco-editor-DYCCzzuR.js";
const s = [
    "assign",
    "flush",
    "ftl",
    ...
    onEnterRules: [
      {
        ...
        action: { indentAction: c.IndentAction.IndentOutdent },
      },
      {
        beforeText: new RegExp(
          `${t.open}#(?!(?:${s.join("|")}))([a-zA-Z_]+)([^/${t.close}]*(?!/)${t.close})[^${t.open}]*$`,
...
function _(t, n) {
  const i = `_${t.id}_${n.id}`,
    e = (u) => u.replace(/__id__/g, i),
    o = (u) => {
...
const b = { conf: l(a), language: _(a, k) },
  x = { conf: l(r), language: _(r, k) },
  $ = { conf: l(a), language: _(a, p) },
  E = { conf: l(r), language: _(r, p) },
  B = { conf: g(), language: A(k) },
  D = { conf: g(), language: A(p) };
export {
