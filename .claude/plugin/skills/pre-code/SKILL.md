---
description: Run the pre-code checklist before writing any component, hook, store slice, or Tauri command. Surfaces architecture decisions and critical gotchas for the area being touched.
---
