---
description: Complete a finished GitHub issue or dispatched task. Calls update_project_task, update_queue_item (if dispatched), and log_to_memory in the correct order.
---
